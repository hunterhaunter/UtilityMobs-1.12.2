...
public class EntityChestEnderGolem extends EntityChestGolem
{
    ...
    public void onLivingUpdate() {
        if (this.world.isRemote && this.rand.nextInt(4) == 0) {
            ...
            for (int i = 3; i-- > 0;) {
                ...
                this.world.spawnParticle(UMSound.PORTAL, this.posX + 0.25 * xOff, this.posY + this.rand.nextFloat(), this.posZ + 0.25 * zOff, vX, vY, vZ);
            }
        }
    ...
    public boolean openGUI(EntityPlayer player) {
        if (!this.world.isRemote) {
            ...
            if (inventory != null) {
                inventory.setChestTileEntity(new TileEntityEnderChestProxy(this)); // Sets this as a "tile entity" for the player's ender chests
